<script lang="ts">
    ...
    const snippets: Abstract[] = [
        ...
        {
            title: "Skills",
            abstract: "Mostly C# and pure JavaScript, but with a sprinkle of Angular, React, TypeScript, Node, Webpack, Web Services, .NET Core, SQL, and Mongo (Phew that's alot!).",
        },
    ];
</script>
